...
purpose:            This method compares the steepest descent method, conjugate gradient method, and gauss elimination method.
'''

import sys, os
sys.path.append(os.path.abspath('../../mylibrary'))
from _mymodules import matrix_solve_steepest_descent, matrix_solve_conjugate_gradient, matrix_solve, matrix_mult, gen_diagdom_sym_matrix, convert_vec_mat, abs_error_2norm

import time

def steepest_descent_conjugate_gradient_gauss_elimination_compare():
    n=100;
    ...
    start_time = time.time()
    solution3 = matrix_solve(random_matrix, b)
    ...
    print("Guass Elimination " + str(n) + "x" + str(n) + ": Absolute Error=" + str(abs_error_2norm([1] * n,solution3)) + " time=" + str(time3))

steepest_descent_conjugate_gradient_gauss_elimination_compare()